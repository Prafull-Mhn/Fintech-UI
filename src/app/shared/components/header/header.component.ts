...
export class HeaderComponent {
  ...
  toggleSidebar() {
    ...
    } else if (localStorage.getItem('algo-tech-sidemenu-styles') == 'icontext') {
      html?.setAttribute(
        'data-toggled',
    ...
    } else if (localStorage.getItem('algo-tech-sidemenu-styles') == 'detached') {
      html?.setAttribute(
        'data-toggled',
    ...
    } else if (localStorage.getItem('algo-tech-sidemenu-styles') == 'doublemenu') {
      html?.setAttribute(
        'data-toggled',
