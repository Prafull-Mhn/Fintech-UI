...
export class SwitcherComponent {
  ...
  themeChange(type: string, type1: string,type2:string) {
    ...
    localStorage.setItem('algo-tech-theme-mode', type);

    this.renderer.setAttribute(htmlElement, 'data-header-styles', type1);
    localStorage.setItem('algo-tech-header-mode', type1);
    this.renderer.setAttribute(htmlElement, 'data-menu-styles', type2);
    localStorage.setItem('algo-tech-menu-mode', type2);
    if (localStorage.getItem('algo-tech-header-mode') == 'light') {
    ...
    if (localStorage.getItem('algo-tech-theme-mode') == 'light') {
      this.elementRef.nativeElement.ownerDocument.documentElement?.removeAttribute('style');
      localStorage.removeItem('ynexlight-background-light');
      localStorage.removeItem('ynexlight-background-body');
      localStorage.removeItem('ynexlight-background-dark');
      localStorage.removeItem('algo-tech-background-mode-dark');
      localStorage.removeItem('algo-tech-background-mode-body');
      localStorage.removeItem('algo-tech-background-mode-light');
      localStorage.removeItem('algo-tech-background-mode-input');
  ...
  DirectionsChange(type: string) {
    ...
    // localStorage.setItem('algo-tech-dir', type);
    const htmlElement =
      this.elementRef.nativeElement.ownerDocument.documentElement;
  ...
  NavigationChange(type: string) {
    ...
    if(type == 'horizontal'){
      ...
      localStorage.setItem('algo-tech-menu-style','menu-click');
      setTimeout(() => {
      ...
      localStorage.removeItem('algo-tech-menu-style');

    }
    localStorage.setItem('algo-tech-nav-mode', type);
  }
  Menustyles(type: string, type1: string) {
    const htmlElement =
      this.elementRef.nativeElement.ownerDocument.documentElement;
    localStorage.setItem('algo-tech-menu-style', type);
    this.renderer.setAttribute(htmlElement, 'data-toggled', type1);
    localStorage.setItem('algo-tech-menu-style', type1);
    this.renderer.setAttribute(htmlElement, 'data-toggled', type1);
    localStorage.setItem('algo-tech-menu-style', type1);
  }
  menuItems!: any;
  Menus(type: string, type1: string) {
    ...
    localStorage.setItem('algo-tech-menu-style', type1);
    localStorage.setItem('algo-tech-menu-style-toggled', type);
    this.renderer.setAttribute(htmlElement, 'data-toggled', type);
    this.renderer.removeAttribute(htmlElement, 'data-vertical-style');
    localStorage.removeItem('algo-tech-sidemenu-styles');
    localStorage.removeItem('algo-tech-sidemenu-styles-toggled');
  ...
  SideMenus(type: string, type1: string) {
    ...
    this.renderer.setAttribute(htmlElement, 'data-vertical-style', type1);
     ...
     if(localStorage.getItem('algo-tech-sidemenu-styles') == 'closed'){
       this.renderer.setAttribute(htmlElement, 'data-toggled', type);
     }
     else if (localStorage.getItem('algo-tech-sidemenu-styles') == 'closed'){
     this.renderer.removeAttribute(htmlElement, 'data-toggled');
     }
     
    localStorage.setItem('algo-tech-sidemenu-styles', type1);
    localStorage.setItem('algo-tech-sidemenu-styles-toggled', type);
    this.renderer.setAttribute(htmlElement, 'data-toggled', type);
    this.renderer.removeAttribute(htmlElement, 'data-nav-style');
    if (type1 === 'icon-text') {
  ...
  PageChange(type: string) {
    ...
    localStorage.setItem('algo-tech-page-mode', type);
  }
  ...
  primary(type: string) {
    ...
    localStorage.setItem('algo-tech-primary-mode', type);
  ...
  background(lightBg:string,inputBorder:string,bodyBg: string, darkBg: string, type: string, type1: string) {
    ...
    localStorage.setItem('algo-tech-background-mode-body', bodyBg);
    localStorage.setItem('algo-tech-background-mode-dark', darkBg);
    localStorage.setItem('algo-tech-background-mode-light', lightBg);
    localStorage.setItem('algo-tech-background-mode-input', inputBorder);
    ...
    localStorage.setItem('algo-tech-menu-mode', type1);
  ...
  public dynamicLightPrimary(data: any): void {
    ...
    // localStorage.removeItem('algo-tech-primary-mode');
  }
  ...
  public dynamicTranparentBgPrimary(data: any,): void {
    ...
    localStorage.setItem('algo-tech-header-mode','dark');
    localStorage.setItem('algo-tech-theme-mode','dark');
  ...
  ImageTheme(type: string) {
    ...
    localStorage.setItem('algo-tech-image', type);
  }
  reset() {
    localStorage.clear();
  ...
  ngOnInit(): void {
    ...
    this.closeMenu(localStorage.getItem('algo-tech-menu-style'));
  }
}
