...
export function handleThemeUpdate(cssVars: any) {
  ...
  export function localStorageBackUp() {
    ...
    if (localStorage.getItem('data-header-styles') == 'dark') {
      if (localStorage.getItem('algo-tech-theme-mode')) {
        const type: any = localStorage.getItem('algo-tech-theme-mode');
    ...
    if (localStorage.getItem('algo-tech-dir') == 'rtl') {
    ...
    if (localStorage.getItem('algo-tech-nav-mode')) {
      const type: any = localStorage.getItem('algo-tech-nav-mode');
    ...
    if (localStorage.getItem('algo-tech-page-mode')) {
      const type: any = localStorage.getItem('algo-tech-page-mode');
      html?.setAttribute('data-page-style', type);
    }
    if (localStorage.getItem('algo-tech-width-mode')) {
      const type: any = localStorage.getItem('algo-tech-width-mode');
      html?.setAttribute('data-width', type);
    }
    if (localStorage.getItem('algo-tech-menu-position')) {
      const type: any = localStorage.getItem('algo-tech-menu-position');
      html?.setAttribute('data-menu-position', type);
    }
    if (localStorage.getItem('algo-tech-menu-mode')) {
      const type: any = localStorage.getItem('algo-tech-menu-mode');
      html?.setAttribute('data-menu-styles', type);
    }
    if (localStorage.getItem('algo-tech-header-position')) {
      const type: any = localStorage.getItem('algo-tech-header-position');
      html?.setAttribute('data-header-position', type);
    }
    if (localStorage.getItem('algo-tech-loader')) {
      const type: any = localStorage.getItem('algo-tech-loader');
      html?.setAttribute('loader', type);
    }
    if (localStorage.getItem('algo-tech-header-mode')) {
      const type: any = localStorage.getItem('algo-tech-header-mode');
      html?.setAttribute('data-header-styles', type);
    }
  
    if (localStorage.getItem("algo-tech-background-mode-body")) {
      const bodytype: any = localStorage.getItem("algo-tech-background-mode-body")
      const darktype: any = localStorage.getItem("algo-tech-background-mode-dark")
      const lighttype: any = localStorage.getItem("algo-tech-background-mode-light")
      const event: any = localStorage.getItem("algo-tech-theme-mode");
    ...
    if (localStorage.getItem("algo-tech-menu-style")) {
      const type1: any = localStorage.getItem("algo-tech-menu-style");
      html?.setAttribute("data-nav-style", type1);
      const type: any = localStorage.getItem('algo-tech-menu-style-toggled');
      html?.setAttribute('data-toggled', type);
    }
    if (localStorage.getItem("algo-tech-sidemenu-styles")) {
      const type1: any = localStorage.getItem("algo-tech-sidemenu-styles");
      html?.setAttribute("data-vertical-style", type1);
      const type: any = localStorage.getItem('algo-tech-sidemenu-styles-toggled');
      html?.setAttribute('data-toggled', type);
    }
    if (localStorage.getItem("algo-tech-sidemenu-styles-toggled")) {
      const type1: any = localStorage.getItem("algo-tech-sidemenu-styles");
      html?.setAttribute("data-vertical-style", type1);
      const type: any = localStorage.getItem('algo-tech-sidemenu-styles-toggled');
      html?.setAttribute('data-toggled', type);
    }
    if (localStorage.getItem("algo-tech-image")) {
      const type: any = localStorage.getItem("algo-tech-image");
      html?.setAttribute('bg-img', type);
    }
    if (localStorage.getItem("algo-tech-primary-mode")) {
      const type: any = localStorage.getItem("algo-tech-primary-mode");
