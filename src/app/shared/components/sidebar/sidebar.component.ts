...
export class SidebarComponent {
 ...
 ngOnInit() {
  ...
  bodyElement.onclick = () => {
    if (
      localStorage.getItem('algo-tech-menu-style') == 'icon-click' ||
      localStorage.getItem('algo-tech-menu-style') == 'menu-click' ||
      localStorage.getItem('algo-tech-menu-style') == 'icon-hover' ||
 ...
 toggleNavActive(item: any) {
  if (localStorage.getItem('algo-tech-sidemenu-styles') == 'icontext') {
    document.querySelector('html')?.setAttribute('icon-text','open')
  }else{
    document.querySelector('html')?.removeAttribute('icon-text')
  }
  if (localStorage.getItem('algo-tech-sidemenu-styles') == 'doublemenu') {
